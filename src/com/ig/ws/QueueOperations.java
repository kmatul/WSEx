...
public class QueueOperations {
	...
	InitialContext jndi = null;
	 ...
	 boolean pushToQueue(int num1,int num2) throws JMSException, NamingException{
...
//		   Destination destination = (Destination) jndi.lookup("GCDQ");
	 ...
	 void getList() throws JMSException, NamingException, MalformedObjectNameException, OpenDataException,MalformedURLException
	 {
